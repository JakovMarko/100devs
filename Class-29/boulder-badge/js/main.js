...
let candieBulbasaur = 16-5;
let candieCaterpie = 7-1;
let candieWeedle = 7-1;
let totalCandies = candieBulbasaur+candieCaterpie+candieWeedle;
...
function choosePokemon(pokemon, number){
    while(number > 0){
        console.log(pokemon);
        number--;
    }
